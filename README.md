...
<html>
  ...
  <body>
    <div class="banner">
      <br />
      <div class="navbar">
        <h1 class="logo">BLUE<span>CREATION</span></h1>
        <ul>
      ...
      <div class="content">
        <div class="text">
          <h2>
            "Carry the Essence of Elegance: Blue Creation - Where Style Meets Functionality" 
          </h2>
          <br />
    ...
    <footer>
      <center>DESIGNED AND DEVELOPED BY VIJEY K S(212223040239)</center>
    </footer>
  </body>
</html>
...
<html>
  ...
  <body>
    <div class="banner">
      <br />
      <div class="navbar">
        <h1 class="logo"><span>BLUE</span>CREATION</h1>
        <ul>
          <li><a href="home.html"> Home </a></li>
          <li><a href="products.html"> Products </a></li>
          <li><a href="people.html"> People </a></li>
    ...
    <div class="banner">
      ...
      <div class="image">
        <table cellspacing="80" >
          <tr align="center">
            <td><img src="Vijey-2.jpeg" /></td>
            <td><img src="Vijay.jpeg" /></td>
            <td><img src="Nani.jpeg" /></td>
            <td><img src="U1.jpeg" /></td>
            <td><img src="Vijay_antony.jpeg" /></td>
          </tr>
          <tr class="space" id="row" align="center">
            <td>VIJEY K S <br>(CEO)</td>
            <td>VIJAY <br>(CO-FOUNDER)</td>
            <td>NANI <br>(DIRECTOR)</td>
            <td>YUVAN SHANKAR RAJA <br>(Asst. DIRECTOR)</td>
            <td>VIJAY ANTONY <br>(CTO)</td>
          </tr>
        </table>
      </div>
    </div>
    ...
    <div class="banner">
      ...
      <div class="box">
        ...
        <div class="box-2">
          ...
          <p><span>Email</span> : bluecreation.official@gmail.com</p>
